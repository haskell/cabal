...
expectedBroken :: IssueID -> IO a
expectedBroken ticket = do
    putStrLn $ "EXPECTED FAIL (" <> show ticket <> ")"
    E.throwIO (TestCodeKnownFail ticket)

unexpectedSuccess :: IssueID -> IO a
unexpectedSuccess ticket = do
