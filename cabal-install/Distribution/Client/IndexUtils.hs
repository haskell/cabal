...
installedSourceHash, blocknoKey, buildTreeRefKey, preferredVersionKey :: String
installedSourceHash = "pkg:"
blocknoKey = "b#"
...
readIndexCacheEntry = \line ->
  case BSS.words line of
    [key, pkgnamestr, pkgverstr, sep, blocknostr]
      | key == BSS.pack installedSourceHash && sep == BSS.pack blocknoKey ->
...
showIndexCacheEntry entry = unwords $ case entry of
   CachePackageId pkgid b -> [ installedSourceHash
