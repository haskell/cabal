...
--
-- Returns a tuple consisting of a list of either removed build tree refs
-- or errors and a function that converts from a provided build tree ref
-- to the corresponding full directory path)
