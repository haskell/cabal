...
import Distribution.Client.Types
         ...
         , ConfiguredPackage(..) , fakeComponentInstanceId)
...
import Distribution.Package
         ( PackageIdentifier, Package(packageId), ComponentInstanceId(..) )
...
--      createDirectoryIfMissing True publicBinDir
      fmap catMaybes $ sequence
        ...
        , let pkgid  = packageId pkg
              ...
              ipid = fakeComponentInstanceId pkgid
  ...
  where
    ...
    pkgBinDir :: PackageDescription -> ComponentInstanceId -> IO FilePath
