...
import Distribution.Simple.Utils (dieWithException, dieWithExceptionCabalInstall)
  ...
  let entriesM :: StateT (Set.Set FilePath) (WriterT [Tar.Entry] IO) ()
      entriesM = do
        ...
        case Tar.toTarPath True prefix of
          Left err -> liftIO $ dieWithExceptionCabalInstall verbosity $ ErrorPackingSdist err
