...
data CabalInstallException
  ...
  | CmdPathRequiresOutputFormat [String] -- Accepted values for the output format
...
exceptionCodeCabalInstall e = case e of
  ...
  CmdPathRequiresOutputFormat{} -> 7162
...
exceptionMessageCabalInstall e = case e of
  ...
  CmdPathRequiresOutputFormat vals ->
    "The 'path' command requires the flag '--output-format'. Allowed values are: "
      ++ intercalate ", " vals
      ++ "."
  CmdPathCommandDoesn'tSupportDryRun ->
