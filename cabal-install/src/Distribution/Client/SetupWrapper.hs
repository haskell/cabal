...
compileSetupExecutable
  ...
  -> Bool
  -> IO FilePath
compileCustomSetupExecutable, compileHooksExecutable
  :: Verbosity
  -> Platform
  -> PackageIdentifier
  -> SetupScriptOptions
...
compileCustomSetupExecutable verbosity platform pkgId opts ver mbCompId forceCompile =
  compileSetupExecutableX "Setup"
    [setupHs opts] (setupProgFile opts)
    verbosity platform pkgId Custom opts ver mbCompId forceCompile
compileHooksExecutable verbosity platform pkgId opts ver mbCompId forceCompile =
  compileSetupExecutableX "SetupHooks"
    [setupHooks opts, hooksHs opts] (hooksProgFile opts)
    verbosity platform pkgId Hooks opts ver mbCompId forceCompile
compileSetupExecutable verbosity platform pkgId bt opts ver mbCompId forceCompile = do
  when (bt == Hooks) $
    void $ compileHooksExecutable verbosity platform pkgId opts ver mbCompId forceCompile
  compileCustomSetupExecutable verbosity platform pkgId opts ver mbCompId forceCompile
