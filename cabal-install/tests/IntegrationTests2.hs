...
testConfigOptionComments = do
  ...
  "repository hackage.haskell.org"  @=? findLineWith "repository hackage.haskell.org" defaultConfigFile
  "  url" @=? findLineWith "url" defaultConfigFile
  "  -- secure" @=? findLineWith "secure" defaultConfigFile
  "  -- root-keys" @=? findLineWith "root-keys" defaultConfigFile
  "  -- key-threshold" @=? findLineWith "key-threshold" defaultConfigFile

  "-- ignore-expiry" @=? findLineWith "ignore-expiry" defaultConfigFile
  "-- http-transport" @=? findLineWith "http-transport" defaultConfigFile
  "-- nix" @=? findLineWith "nix" defaultConfigFile
  "-- store-dir" @=? findLineWith "store-dir" defaultConfigFile
  "-- active-repositories" @=? findLineWith "active-repositories" defaultConfigFile
  "-- local-no-index-repo" @=? findLineWith "local-no-index-repo" defaultConfigFile
  "remote-repo-cache"  @=? findLineWith "remote-repo-cache" defaultConfigFile
  "-- logs-dir"  @=? findLineWith "logs-dir" defaultConfigFile
  "-- default-user-config" @=? findLineWith "default-user-config" defaultConfigFile
  "-- verbose" @=? findLineWith "verbose" defaultConfigFile
  "-- compiler" @=? findLineWith "compiler" defaultConfigFile
  "-- cabal-file" @=? findLineWith "cabal-file" defaultConfigFile
  "-- with-compiler" @=? findLineWith "with-compiler" defaultConfigFile
  "-- with-hc-pkg" @=? findLineWith "with-hc-pkg" defaultConfigFile
  "-- program-prefix" @=? findLineWith "program-prefix" defaultConfigFile
  "-- program-suffix" @=? findLineWith "program-suffix" defaultConfigFile
  "-- library-vanilla" @=? findLineWith "library-vanilla" defaultConfigFile
  "-- library-profiling" @=? findLineWith "library-profiling" defaultConfigFile
  "-- shared" @=? findLineWith "shared" defaultConfigFile
  "-- static" @=? findLineWith "static" defaultConfigFile
  "-- executable-dynamic" @=? findLineWith "executable-dynamic" defaultConfigFile
  "-- executable-static" @=? findLineWith "executable-static" defaultConfigFile
  "-- profiling" @=? findLineWith "profiling" defaultConfigFile
  "-- executable-profiling" @=? findLineWith "executable-profiling" defaultConfigFile
  "-- profiling-detail" @=? findLineWith "profiling-detail" defaultConfigFile
  "-- library-profiling-detail" @=? findLineWith "library-profiling-detail" defaultConfigFile
  "-- optimization" @=? findLineWith "optimization" defaultConfigFile
  "-- debug-info" @=? findLineWith "debug-info" defaultConfigFile
  "-- build-info" @=? findLineWith "build-info" defaultConfigFile
  "-- library-for-ghci" @=? findLineWith "library-for-ghci" defaultConfigFile
  "-- split-sections" @=? findLineWith "split-sections" defaultConfigFile
  "-- split-objs" @=? findLineWith "split-objs" defaultConfigFile
  "-- executable-stripping" @=? findLineWith "executable-stripping" defaultConfigFile
  "-- library-stripping" @=? findLineWith "library-stripping" defaultConfigFile
  "-- configure-option" @=? findLineWith "configure-option" defaultConfigFile
  "-- user-install"  @=? findLineWith "user-install" defaultConfigFile
  "-- package-db"  @=? findLineWith "package-db" defaultConfigFile
  "-- flags" @=? findLineWith "flags" defaultConfigFile
  "-- extra-include-dirs" @=? findLineWith "extra-include-dirs" defaultConfigFile
  "-- deterministic" @=? findLineWith "deterministic" defaultConfigFile
  "-- cid" @=? findLineWith "cid" defaultConfigFile
  "-- extra-lib-dirs" @=? findLineWith "extra-lib-dirs" defaultConfigFile
  "-- extra-lib-dirs-static" @=? findLineWith "extra-lib-dirs-static" defaultConfigFile
  "-- extra-framework-dirs" @=? findLineWith "extra-framework-dirs" defaultConfigFile
  "extra-prog-path"  @=? findLineWith "extra-prog-path" defaultConfigFile
  "-- instantiate-with" @=? findLineWith "instantiate-with" defaultConfigFile
  "-- tests" @=? findLineWith "tests" defaultConfigFile
  "-- coverage" @=? findLineWith "coverage" defaultConfigFile
  "-- library-coverage" @=? findLineWith "library-coverage" defaultConfigFile
  "-- exact-configuration" @=? findLineWith "exact-configuration" defaultConfigFile
  "-- benchmarks" @=? findLineWith "benchmarks" defaultConfigFile
  "-- relocatable"  @=? findLineWith "relocatable" defaultConfigFile
  "-- response-files" @=? findLineWith "response-files" defaultConfigFile
  "-- allow-depending-on-private-libs" @=? findLineWith "allow-depending-on-private-libs" defaultConfigFile
  "-- cabal-lib-version" @=? findLineWith "cabal-lib-version" defaultConfigFile
  "-- append" @=? findLineWith "append" defaultConfigFile
  "-- backup" @=? findLineWith "backup" defaultConfigFile
  "-- constraint" @=? findLineWith "constraint" defaultConfigFile
  "-- preference" @=? findLineWith "preference" defaultConfigFile
  "-- solver"  @=? findLineWith "solver" defaultConfigFile
  "-- allow-older"  @=? findLineWith "allow-older" defaultConfigFile
  "-- allow-newer"  @=? findLineWith "allow-newer" defaultConfigFile
  "-- write-ghc-environment-files" @=? findLineWith "write-ghc-environment-files" defaultConfigFile
  "-- documentation"  @=? findLineWith "documentation" defaultConfigFile
  "-- doc-index-file"  @=? findLineWith "doc-index-file" defaultConfigFile
  "-- only-download"  @=? findLineWith "only-download" defaultConfigFile
  "-- target-package-db" @=? findLineWith "target-package-db" defaultConfigFile
  "-- max-backjumps"  @=? findLineWith "max-backjumps" defaultConfigFile
  "-- reorder-goals"  @=? findLineWith "default-user-config" defaultConfigFile
  "-- count-conflicts"  @=? findLineWith "count-conflicts" defaultConfigFile
  "-- fine-grained-conflicts"  @=? findLineWith "fine-grained-conflicts" defaultConfigFile
  "-- minimize-conflict-set"  @=? findLineWith "minimize-conflict-set" defaultConfigFile
  "-- independant-goals"  @=? findLineWith "independant-goals" defaultConfigFile
  "-- prefer-oldest"  @=? findLineWith "prefer-oldest" defaultConfigFile
  "-- shadow-installed-packages"  @=? findLineWith "shadow-installed-packages" defaultConfigFile
  "-- strong-flags"  @=? findLineWith "strong-flags" defaultConfigFile
  "-- allow-boot-library-installs"  @=? findLineWith "allow-boot-library-installs" defaultConfigFile
  "-- reject-unconstrained-dependencies"  @=? findLineWith "reject-unconstrained-dependencies" defaultConfigFile
  "-- reinstall"  @=? findLineWith "reinstall" defaultConfigFile
  "-- avoid-reinstalls"  @=? findLineWith "avoid-reinstalls" defaultConfigFile
  "-- force-reinstalls"  @=? findLineWith "force-reinstalls" defaultConfigFile
  "-- upgrade-dependencies"  @=? findLineWith "upgrade-dependencies" defaultConfigFile
  "-- index-state" @=? findLineWith "index-state" defaultConfigFile
  "-- root-cmd" @=? findLineWith "root-cmd" defaultConfigFile
  "-- symlink-bindir" @=? findLineWith "symlink-bindir" defaultConfigFile
  "build-summary"  @=? findLineWith "build-summary" defaultConfigFile
  "-- build-log" @=? findLineWith "build-log" defaultConfigFile
  "remote-build-reporting"  @=? findLineWith "remote-build-reporting" defaultConfigFile
  "-- report-planning-failure"  @=? findLineWith "report-planning-failure" defaultConfigFile
  "-- per-component"  @=? findLineWith "per-component" defaultConfigFile
  "-- run-tests" @=? findLineWith "run-tests" defaultConfigFile
  "jobs"  @=? findLineWith "jobs" defaultConfigFile
  "-- keep-going"  @=? findLineWith "keep-going" defaultConfigFile
  "-- offline"  @=? findLineWith "offline" defaultConfigFile
  "-- lib" @=? findLineWith "lib" defaultConfigFile
  "-- package-env" @=? findLineWith "package-env" defaultConfigFile
  "-- overwrite-policy" @=? findLineWith "overwrite-policy" defaultConfigFile
  "-- install-method" @=? findLineWith "install-method" defaultConfigFile
  "installdir"  @=? findLineWith "installdir" defaultConfigFile
  "-- username" @=? findLineWith "username" defaultConfigFile
  "-- password" @=? findLineWith "password" defaultConfigFile
  "-- password-command" @=? findLineWith "password-command" defaultConfigFile
  "-- builddir" @=? findLineWith "builddir" defaultConfigFile


  "haddock"  @=? findLineWith "haddock" defaultConfigFile
  "  -- keep-temp-files" @=? findLineWith "keep-temp-files" defaultConfigFile
  "  -- hoogle" @=? findLineWith "hoogle" defaultConfigFile
  "  -- html" @=? findLineWith "html" defaultConfigFile
  "  -- html-location" @=? findLineWith "html-location" defaultConfigFile
  "  -- executables" @=? findLineWith "executables" defaultConfigFile
  "  -- benchmarks" @=? findLineWith "benchmarks" defaultConfigFile
  "  -- foreign-libraries" @=? findLineWith "foreign-libraries" defaultConfigFile
  "  -- all" @=? findLineWith "all" defaultConfigFile
  "  -- internal" @=? findLineWith "internal" defaultConfigFile
  "  -- css" @=? findLineWith "css" defaultConfigFile
  "  -- hyperlink-source" @=? findLineWith "hyperlink-source" defaultConfigFile
  "  -- quickjump" @=? findLineWith "quickjump" defaultConfigFile
  "  -- hscolour-css" @=? findLineWith "hscolour-css" defaultConfigFile
  "  -- contents-location" @=? findLineWith "contents-location" defaultConfigFile
  "  -- index-location" @=? findLineWith "index-location" defaultConfigFile
  "  -- base-url" @=? findLineWith "base-url" defaultConfigFile
  "  -- lib" @=? findLineWith "lib" defaultConfigFile
  "  -- output-dir" @=? findLineWith "output-dir" defaultConfigFile


  "init"  @=? findLineWith "init" defaultConfigFile
  "  -- interactive" @=? findLineWith "interactive" defaultConfigFile
  "  -- quiet" @=? findLineWith "quiet" defaultConfigFile
  "  -- no-comments" @=? findLineWith "no-comments" defaultConfigFile
  "  -- minimal" @=? findLineWith "minimal" defaultConfigFile
  "  -- cabal-version" @=? findLineWith "cabal-version" defaultConfigFile
  "  -- license" @=? findLineWith "license" defaultConfigFile
  "  -- extra-doc-file" @=? findLineWith "extra-doc-file" defaultConfigFile
  "  -- test-dir" @=? findLineWith "test-dir" defaultConfigFile
  "  -- simple" @=? findLineWith "simple" defaultConfigFile
  "  -- language" @=? findLineWith "language" defaultConfigFile
  "  -- application-dir" @=? findLineWith "application-dir" defaultConfigFile
  "  -- source-dir" @=? findLineWith "source-dir" defaultConfigFile
  
  
  "install-dirs user"  @=? findLineWith "install-dirs user" defaultConfigFile
  "install-dirs global"  @=? findLineWith "install-dirs user" defaultConfigFile
  "  -- prefix"  @=? findLineWith "prefix" defaultConfigFile
  "  -- bindir"@=? findLineWith "bindir" defaultConfigFile
  "  -- libdir" @=? findLineWith "libdir" defaultConfigFile
  "  -- libsubdir" @=? findLineWith "libsubdir" defaultConfigFile
  "  -- dynlibdir" @=? findLineWith "dynlibdir" defaultConfigFile
  "  -- libexecdir" @=? findLineWith "libexecdir" defaultConfigFile
  "  -- libexecsubdir" @=? findLineWith "libexecsubdir" defaultConfigFile
  "  -- datadir" @=? findLineWith "datadir" defaultConfigFile
  "  -- datasubdir" @=? findLineWith "datasubdir" defaultConfigFile
  "  -- docdir" @=? findLineWith "docdir" defaultConfigFile
  "  -- htmldir" @=? findLineWith "htmldir" defaultConfigFile
  "  -- haddockdir" @=? findLineWith "haddockdir" defaultConfigFile
  "  -- sysconfdir" @=? findLineWith "sysconfdir" defaultConfigFile

  "program-locations"  @=? findLineWith "program-locations" defaultConfigFile
  "  -- alex-location" @=? findLineWith "alex-location" defaultConfigFile
  "  -- ar-location" @=? findLineWith "ar-location" defaultConfigFile
  "  -- c2hs-location" @=? findLineWith "c2hs-location" defaultConfigFile
  "  -- cpphs-location" @=? findLineWith "cpphs-location" defaultConfigFile
  "  -- doctest-location" @=? findLineWith "doctest-location" defaultConfigFile
  "  -- gcc-location" @=? findLineWith "gcc-location" defaultConfigFile
  "  -- ghc-location" @=? findLineWith "ghc-location" defaultConfigFile
  "  -- ghc-pkg-location" @=? findLineWith "ghc-pkg-location" defaultConfigFile
  "  -- ghcjs-location" @=? findLineWith "ghcjs-location" defaultConfigFile
  "  -- ghcjs-pkg-location" @=? findLineWith "ghcjs-pkg-location" defaultConfigFile
  "  -- greencard-location" @=? findLineWith "greencard-location" defaultConfigFile
  "  -- haddock-location" @=? findLineWith "haddock-location" defaultConfigFile
  "  -- happy-location" @=? findLineWith "happy-location" defaultConfigFile
  "  -- haskell-suite-location" @=? findLineWith "haskell-suite-location" defaultConfigFile
  "  -- haskell-suite-pkg-location" @=? findLineWith "haskell-suite-pkg-location" defaultConfigFile
  "  -- hmake-location" @=? findLineWith "hmake-location" defaultConfigFile
  "  -- hpc-location" @=? findLineWith "hpc-location" defaultConfigFile
  "  -- hscolour-location" @=? findLineWith "hscolour-location" defaultConfigFile
  "  -- jhc-location" @=? findLineWith "jhc-location" defaultConfigFile
  "  -- ld-location" @=? findLineWith "ld-location" defaultConfigFile
  "  -- pkg-config-location" @=? findLineWith "pkg-config-location" defaultConfigFile
  "  -- runghc-location" @=? findLineWith "runghc-location" defaultConfigFile
  "  -- strip-location" @=? findLineWith "strip-location" defaultConfigFile
  "  -- tar-location" @=? findLineWith "tar-location" defaultConfigFile
  "  -- uhc-location" @=? findLineWith "uhc-location" defaultConfigFile


  "program-default-options"  @=? findLineWith "program-default-options" defaultConfigFile
  "  -- alex-options" @=? findLineWith "alex-options" defaultConfigFile
  "  -- ar-options" @=? findLineWith "ar-options" defaultConfigFile
  "  -- c2hs-options" @=? findLineWith "c2hs-options" defaultConfigFile
  "  -- cpphs-options" @=? findLineWith "cpphs-options" defaultConfigFile
  "  -- doctest-options" @=? findLineWith "doctest-options" defaultConfigFile
  "  -- gcc-options" @=? findLineWith "gcc-options" defaultConfigFile
  "  -- ghc-options" @=? findLineWith "ghc-options" defaultConfigFile
  "  -- ghc-pkg-options" @=? findLineWith "ghc-pkg-options" defaultConfigFile
  "  -- ghcjs-options" @=? findLineWith "ghcjs-options" defaultConfigFile
  "  -- ghcjs-pkg-options" @=? findLineWith "ghcjs-pkg-options" defaultConfigFile
  "  -- greencard-options" @=? findLineWith "greencard-options" defaultConfigFile
  "  -- haddock-options" @=? findLineWith "haddock-options" defaultConfigFile
  "  -- happy-options" @=? findLineWith "happy-options" defaultConfigFile
  "  -- haskell-suite-options" @=? findLineWith "haskell-suite-options" defaultConfigFile
  "  -- haskell-suite-pkg-options" @=? findLineWith "haskell-suite-pkg-options" defaultConfigFile
  "  -- hmake-options" @=? findLineWith "hmake-options" defaultConfigFile
  "  -- hpc-options" @=? findLineWith "hpc-options" defaultConfigFile
  "  -- hsc2hs-options" @=? findLineWith "hsc2hs-options" defaultConfigFile
  "  -- hscolour-options" @=? findLineWith "hscolour-options" defaultConfigFile
  "  -- jhc-options" @=? findLineWith "jhc-options" defaultConfigFile
  "  -- ld-options" @=? findLineWith "ld-options" defaultConfigFile
  "  -- pkg-config-options" @=? findLineWith "pkg-config-options" defaultConfigFile
  "  -- runghc-options" @=? findLineWith "runghc-options" defaultConfigFile
  "  -- strip-options" @=? findLineWith "strip-options" defaultConfigFile
  "  -- tar-options" @=? findLineWith "tar-options" defaultConfigFile
  "  -- uhc-options" @=? findLineWith "uhc-options" defaultConfigFile
  where
    -- | Find lines containing a target string.
    findLineWith :: String -> String -> String
    findLineWith target text
      | L.any (isInfixOf (" " ++ target ++ ":")) . lines $ text = removeCommentValue . L.head . filter (isInfixOf (" " ++ target ++ ":")) . lines $ text
      | otherwise  = ""
