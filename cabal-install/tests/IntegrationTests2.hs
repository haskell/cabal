...
testDefaultFlags = do
  ...
  "-- executable-dynamic: False" @=? findLineWith "executable-dynamic" defaultConfigFile
  "-- executable-static: False" @=? findLineWith "executable-static" defaultConfigFile
  "-- optimization: True" @=? findLineWith "optimization" defaultConfigFile
  
  "-- lib: False" @=? findLineWith "lib" defaultConfigFile
  "-- verbose: 1" @=? findLineWith "verbose" defaultConfigFile
  "-- compiler: ghc" @=? findLineWith "compiler" defaultConfigFile
  "-- tests: False" @=? findLineWith "tests" defaultConfigFile
  "-- benchmarks: False" @=? findLineWith "benchmarks" defaultConfigFile
  "-- ignore-expiry: False" @=? findLineWith "ignore-expiry" defaultConfigFile
  "-- library-vanilla: True" @=? findLineWith "library-vanilla" defaultConfigFile
  "-- debug-info: False" @=? findLineWith "debug-info" defaultConfigFile
  "-- split-sections: False" @=? findLineWith "split-sections" defaultConfigFile
  "-- split-objs: False" @=? findLineWith "split-objs" defaultConfigFile
  "-- coverage: False" @=? findLineWith "coverage" defaultConfigFile
  "-- exact-configuration: False" @=? findLineWith "exact-configuration" defaultConfigFile
  "-- relocatable: False"  @=? findLineWith "relocatable" defaultConfigFile
  "-- solver: modular"  @=? findLineWith "solver" defaultConfigFile
  "-- allow-older: False"  @=? findLineWith "allow-older" defaultConfigFile
  "-- allow-newer: False"  @=? findLineWith "allow-newer" defaultConfigFile
  "-- documentation: False"  @=? findLineWith "documentation" defaultConfigFile
  "-- doc-index-file: $datadir/doc/$arch-$os-$compiler/index.html"  @=? findLineWith "doc-index-file" defaultConfigFile
  "-- only-download: False"  @=? findLineWith "only-download" defaultConfigFile
  "-- max-backjumps: 4000"  @=? findLineWith "max-backjumps" defaultConfigFile
  ...
  "  -- secure: True" @=? findLineWith "secure" defaultConfigFile
  "  -- key-threshold: 3" @=? findLineWith "key-threshold" defaultConfigFile
  "  -- keep-temp-files: False" @=? findLineWith "keep-temp-files" defaultConfigFile
  "  -- hoogle: False" @=? findLineWith "hoogle" defaultConfigFile
  "  -- html: False" @=? findLineWith "html" defaultConfigFile
  "  -- executables: False" @=? findLineWith "executables" defaultConfigFile

  
  "  url: http://hackage.haskell.org/" @=? findLineWith "url" defaultConfigFile
  "  -- foreign-libraries: False" @=? findLineWith "foreign-libraries" defaultConfigFile
  "  -- internal: False" @=? findLineWith "internal" defaultConfigFile
  "  -- hyperlink-source: False" @=? findLineWith "hyperlink-source" defaultConfigFile
  "  -- quickjump: False" @=? findLineWith "quickjump" defaultConfigFile
  "  -- interactive: False" @=? findLineWith "interactive" defaultConfigFile
  "  -- quiet: False" @=? findLineWith "quiet" defaultConfigFile
  "  -- no-comments: False" @=? findLineWith "no-comments" defaultConfigFile
  "  -- minimal: False" @=? findLineWith "minimal" defaultConfigFile
  "  -- cabal-version: 3.0" @=? findLineWith "cabal-version" defaultConfigFile
  "  -- simple: False" @=? findLineWith "simple" defaultConfigFile
  "  -- language: Haskell2010" @=? findLineWith "language" defaultConfigFile
  "  -- application-dir: app" @=? findLineWith "application-dir" defaultConfigFile
  "  -- source-dir: src" @=? findLineWith "source-dir" defaultConfigFile
  "  -- bindir: $prefix/bin"@=? findLineWith "bindir" defaultConfigFile
  "  -- libdir: $prefix/lib" @=? findLineWith "libdir" defaultConfigFile
  "  -- libsubdir: $abi/$libname" @=? findLineWith "libsubdir" defaultConfigFile
  "  -- dynlibdir: $libdir/$abi" @=? findLineWith "dynlibdir" defaultConfigFile
  "  -- libexecdir: $prefix/libexec" @=? findLineWith "libexecdir" defaultConfigFile
  "  -- libexecsubdir: $abi/$pkgid" @=? findLineWith "libexecsubdir" defaultConfigFile
  "  -- datadir: $prefix/share" @=? findLineWith "datadir" defaultConfigFile
  "  -- datasubdir: $abi/$pkgid" @=? findLineWith "datasubdir" defaultConfigFile
  "  -- docdir: $datadir/doc/$abi/$pkgid" @=? findLineWith "docdir" defaultConfigFile
  "  -- htmldir: $docdir/html" @=? findLineWith "htmldir" defaultConfigFile
  "  -- haddockdir: $htmldir" @=? findLineWith "haddockdir" defaultConfigFile
  "  -- sysconfdir: $prefix/etc" @=? findLineWith "sysconfdir" defaultConfigFile
  where
    -- | Find lines containing a target string.
    findLineWith :: String -> String -> String
    findLineWith target text
      | L.any (isInfixOf (" " ++ target ++ ":")) . lines $ text = L.head . filter (isInfixOf (" " ++ target ++ ":")) . lines $ text
      | otherwise  = ""
