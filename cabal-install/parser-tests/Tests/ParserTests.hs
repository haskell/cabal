...
testProjectConfigShared = do
  ...
  where
    ...
    projectConfigBuildHcFlavor = toFlag GHC
    projectConfigBuildHcPath = toFlag "/some/path/to/build-compiler"
    projectConfigBuildHcPkg = toFlag "/some/path/to/build-ghc-pkg"
