...
-- TODO: change this to use relative context
type ExactField = FieldConcrete Position
...
runRenderFields :: [ExactField (WithComments Position)] -> BS.ByteString
runRenderFields = runRenderFields' cfg
  where
    cfg = RenderConfig{renderLineEnding = LF}

runRenderFields' :: RenderConfig -> [ExactField (WithComments Position)] -> BS.ByteString
...
renderFields :: [ExactField (WithComments Position)] -> RenderM ()
renderFields = traverse_ renderField

renderField :: ExactField (WithComments Position) -> RenderM ()
renderField (FieldConcrete colonPos fname fls) = renderFieldName fname colonPos >> renderFieldLines fls
renderField (SectionConcrete sname sargs fs) = renderSectionName sname >> renderSectionArgs sargs >> renderFields fs
