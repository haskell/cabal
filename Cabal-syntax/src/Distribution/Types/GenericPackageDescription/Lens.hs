...
import Distribution.Types.Benchmark (BenchmarkWith)
import Distribution.Types.CondTree (CondTree)
import Distribution.Types.ConfVar (ConfVar (..))
import Distribution.Types.Executable (ExecutableWith)
import Distribution.Types.Flag (FlagName, PackageFlag (MkPackageFlag))
import Distribution.Types.ForeignLib (ForeignLibWith)
import Distribution.Types.GenericPackageDescription (GenericPackageDescription, GenericPackageDescriptionWith (..))
import Distribution.Types.Library (LibraryWith)
import Distribution.Types.PackageDescription (PackageDescriptionWith)
import Distribution.Types.TestSuite (TestSuiteWith)
