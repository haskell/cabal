...
condLibrary_ :: Lens' GenericPackageDescription (Maybe (CondTree ConfVar [LibDependency] Library))
condLibrary_ = lens condLibrary $ \s a -> s { condLibrary = a}

condExecutables_ :: Lens' GenericPackageDescription [(UnqualComponentName, CondTree ConfVar [LibDependency] Executable)]
