...
module Distribution.Verbosity
  ...
  , VerbosityLevel (..)
  , verbosityLevel
  , verbosityStdoutHandle
  , verbosityStderrHandle
...
verbosityStdoutHandle :: Verbosity -> Handle
verbosityStdoutHandle verb =
  if isVerboseStderr (verbosityFlags verb)
    then vStderrHandle $ verbosityHandles verb
    else vStdoutHandle $ verbosityHandles verb

verbosityStderrHandle :: Verbosity -> Handle
verbosityStderrHandle = vStderrHandle . verbosityHandles
