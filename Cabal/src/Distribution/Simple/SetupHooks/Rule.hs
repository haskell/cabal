...
computeRules
  ...
  -> env
  -> Rules env
  -> IO (Map RuleId Rule, [MonitorFileOrDir])
...
-- SetupHooks TODO: use the full cabal-install file monitor definitions;
-- this will require moving it to a package that can be imported from Cabal.
