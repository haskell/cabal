...
-- information.
addExtraCSources :: BuildInfo -> [SymbolicPath "Package" File] -> BuildInfo
...
-- | Add extra C++ sources generated by preprocessing to build
-- information.
addExtraCxxSources :: BuildInfo -> [SymbolicPath "Package" File] -> BuildInfo
...
-- | Add extra C-- sources generated by preprocessing to build
-- information.
addExtraCmmSources :: BuildInfo -> [SymbolicPath "Package" File] -> BuildInfo
...
-- information.
addExtraAsmSources :: BuildInfo -> [SymbolicPath "Package" File] -> BuildInfo
...
-- information.
addExtraJsSources :: BuildInfo -> [SymbolicPath "Package" File] -> BuildInfo
