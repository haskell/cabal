...
ppExplanation CVAutogenPackageInfo =
  "The autogenerated module PackageInfo_* is new in Cabal-3.10.1.0. You need "
    ++ "to specify 'cabal-version: 3.10' or higher."
...
checkCabalVersion pkg =
  catMaybes
    ...
    , checkVersion CabalSpecV3_10 (elem (autogenPackageInfoModuleName pkg) allModuleNames) $
