...
import Distribution.Package
         ...
         , packageName, packageVersion, ComponentInstanceId(..) )
...
data InstalledPackageInfo
   = InstalledPackageInfo {
        ...
        compatPackageKey   :: ComponentInstanceId,
        license           :: License,
        copyright         :: String,
        maintainer        :: String,
        author            :: String,
...
instance Package.HasComponentInstanceId InstalledPackageInfo where
...
data OriginalModule
   = OriginalModule {
       originalPackageId :: ComponentInstanceId,
...
basicFieldDescrs =
 ...
 , simpleField "id"
                           disp                   parse
                           installedSourceHash             (\pk pkg -> pkg{installedSourceHash=pk})
 , simpleField "key"
                           disp                   parse
