...
import Distribution.Package
         ( PackageId, ComponentInstanceId, getHSLibraryName )
...
componentGhcOptions verbosity lbi bi clbi odir =
    mempty {
      ...
      ghcOptComponentInstanceId  = case clbi of
  ...
  where
    ...
    hole_insts = map (\(k,(p,n)) -> (k, (InstalledPackageInfo.installedSourceHash p,n)))
...
mkGHCiLibName :: ComponentInstanceId -> String
...
mkGhcOptPackages :: ComponentLocalBuildInfo
                 -> [(ComponentInstanceId, PackageId, ModuleRenaming)]
