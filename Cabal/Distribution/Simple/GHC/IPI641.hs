...
import qualified Distribution.Package as Current hiding (installedSourceHash)
...
mkComponentInstanceId :: Current.PackageIdentifier -> Current.ComponentInstanceId
mkComponentInstanceId = Current.ComponentInstanceId . display
...
toCurrent ipi@InstalledPackageInfo{} =
  ...
  in Current.InstalledPackageInfo {
    ...
    Current.installedSourceHash         = mkComponentInstanceId pid,
    Current.compatPackageKey   = mkComponentInstanceId pid,
    ...
    Current.depends            = map (mkComponentInstanceId.convertPackageId) (depends ipi),
