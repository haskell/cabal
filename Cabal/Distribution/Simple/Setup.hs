...
testCommand :: (ShowOrParseArgs -> [OptionField a]) -> a
            -> CommandUI (a, TestFlags)
testCommand buildOpts buildDefaults = CommandUI
  { commandName         = "test"
  , commandSynopsis     =
  ...
  , commandDefaultFlags = (buildDefaults, defaultTestFlags)
  , commandOptions = \showOrParseArgs ->
      liftOptions getR setR
      ...
      ++ liftOptions getL setL (buildOpts showOrParseArgs)
  }
  where
    getL = fst; setL a (_, b) = (a, b)
    getR = snd; setR b (a, _) = (a, b)
