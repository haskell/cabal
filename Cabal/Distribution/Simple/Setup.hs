...
data ConfigFlags = ConfigFlags {
    ...
    configConstraints :: [Dependency], -- ^Additional constraints for
                                       -- dependencies.
    configDependencies :: [(PackageName, ComponentInstanceId)],
    configInstantiateWith :: [(ModuleName, (ComponentInstanceId, ModuleName))],
...
parseDependency :: Parse.ReadP r (PackageName, ComponentInstanceId)
parseDependency = do
  x <- parse
  _ <- Parse.char '='
  y <- parse
...
parseHoleMapEntry :: Parse.ReadP r (ModuleName, (ComponentInstanceId, ModuleName))
