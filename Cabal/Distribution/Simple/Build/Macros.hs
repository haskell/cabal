...
import Distribution.Simple.LocalBuildInfo
         ( LocalBuildInfo(compiler, withPrograms), externalPackageDeps, localInstalledUnitId )
...
generate _pkg_descr lbi =
  ...
  generateInstalledUnitIdMacro lbi
...
generateInstalledUnitIdMacro :: LocalBuildInfo -> String
generateInstalledUnitIdMacro lbi
  | installedUnitIdSupported (compiler lbi) =
      "#define CURRENT_PACKAGE_KEY \"" ++ display (localInstalledUnitId lbi) ++ "\"\n\n"
  | otherwise = ""
