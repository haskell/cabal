...
import Distribution.Simple.LocalBuildInfo
         ( LocalBuildInfo(compiler, withPrograms), externalPackageDeps, localComponentInstanceId )
...
generate _pkg_descr lbi =
  ...
  generateComponentInstanceIdMacro lbi
...
generateComponentInstanceIdMacro :: LocalBuildInfo -> String
generateComponentInstanceIdMacro lbi
  | installedSourceHashSupported (compiler lbi) =
      "#define CURRENT_PACKAGE_KEY \"" ++ display (localComponentInstanceId lbi) ++ "\"\n\n"
  | otherwise = ""
