...
testSuiteLibV09AsLibAndExe pkg_descr
  ...
  where
    ...
    libClbi = LibComponentLocalBuildInfo
                ...
                , componentSourceHash = ComponentInstanceId $ display (packageId pkg)
                , componentCompatPackageKey = ComponentInstanceId $ display (packageId pkg)
    ...
    exeClbi = ExeComponentLocalBuildInfo {
                componentPackageDeps =
                    (IPI.installedSourceHash ipi, packageId ipi)
