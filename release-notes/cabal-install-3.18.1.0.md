...
- `cabal-install build` leaves a number of temporary (`.tmp` extension)
  files in the user’s temporary folder (e.g. `/tmp`)
  [#12244](https://github.com/haskell/cabal/issues/12244)
...
- Parser warnings [#12245](https://github.com/haskell/cabal/issues/12245)
